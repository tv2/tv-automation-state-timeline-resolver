        ...
        _.each(mappings, (foundMapping, layerName) => {
            if (foundMapping &&
                ...
                if (foregroundStateLayer) {
                    const currentTemplateData = channel.layers[mapping.layer] ? channel.layers[mapping.layer].templateData : undefined;
                    const foregroundTemplateData = foregroundStateLayer ? foregroundStateLayer.templateData : undefined;
                    channel.layers[mapping.layer] = merge(channel.layers[mapping.layer], {
                        ...foregroundStateLayer,
                        ...(currentTemplateData && foregroundTemplateData ? { templateData: lib_1.deepExtend(currentTemplateData, foregroundTemplateData) } : {}),
