...
import { DeviceType, DeviceOptions, QuantelOptions, QuantelControlMode, QuantelOutTransition } from '../types/src';
 ...
 */
export declare class QuantelDevice extends DeviceWithState<QuantelState> {
    private _quantel;
    ...
    constructor(deviceId: string, deviceOptions: QuantelDeviceOptions, options: any);
    init(connectionOptions: QuantelOptions): Promise<boolean>;
    /**
