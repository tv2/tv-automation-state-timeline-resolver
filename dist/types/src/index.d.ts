...
export declare type TimelineContentTypeAny = TimelineContentTypeAtem | TimelineContentTypeCasparCg | TimelineContentTypeHttp | TimelineContentTypeHyperdeck | TimelineContentTypeLawo | TimelineContentTypeOSC | TimelineContentTypePharos | TimelineContentTypePanasonicPtz;
export declare type TimelineObjectAny = TimelineObjEmpty | TimelineObjAtemAny | TimelineObjCCGAny | TimelineObjHTTPRequest | TimelineObjHyperdeckAny | TimelineObjLawoAny | TimelineObjOSCMessage | TimelineObjPanasonicPtzAny | TimelineObjPharosAny;
